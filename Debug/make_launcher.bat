...
@REM   i.e.   ${workspace_loc:Erika_Demo}/make_launcher.bat

@REM   Unset CWD and PWD. They may cause cygwin warning.
@set CWD=
@set PWD=

@set EE_BASH_PATH=C:\cygwin64\bin\bash
...
@set ERIKA_FILES=C:\Users\chungtv\Downloads\Compressed\eclipse\plugins\com.eu.evidence.ee_2.7.0.20160615_1643\ee_files
